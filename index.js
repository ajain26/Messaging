...
io.on('connection', function(clientSocket){
      ...
      clientSocket.on('chatMessage', function(clientNickname, message, to){
                      var currentDateTime = new Date().toLocaleString();
                      delete typingUsers[clientNickname];
                      io.emit("userTypingUpdate", typingUsers);
                      io.emit('newChatMessage', clientNickname, message, currentDateTime,to);
                    
                      });
      
      
      
         clientSocket.on("completeList", function() {
                      
                      io.emit("dataList", userList);
                      });
